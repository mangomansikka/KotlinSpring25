...
internal class LottoTest {
    ...
    fun guessedNumbers() {
        ...
        assert(lotto.guessedNumbers("1 2 3 4 5 6 7 8") == null)
        assert(lotto.guessedNumbers("1 2 3 4 5 6 7 41") == null)
    }
    ...
    fun equalsCount() {
        ...
        assert(lotto.equalsCount(listOf(1, 2, 3, 4, 5, 6, 7), listOf(1, 2, 3, 4, 5, 6, 41)) == 6)
    }
}